...
from deebot_client.commands.json.clean import CleanArea, GetCleanInfo
from deebot_client.commands.json.clean_V2 import Clean_V2
...
DEVICES[short_name(__name__)] = StaticDeviceInfo(
    ...
    Capabilities(
        ...
        clean=CapabilityClean(
            action=CapabilityCleanAction(command=Clean_V2, area=CleanArea),
